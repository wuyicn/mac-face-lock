...
**Architecture:** 只修改 `README.md`，在安全提醒之后、系统要求之前插入独立预览章节。使用仓库相对路径引用现有已跟踪 PNG，不复制或重新编码图片。
...
- [ ] **Step 1: 运行内容检查并确认当前 README 缺少预览章节**
...
- [ ] **Step 5: 推送分支并确认 GitHub README 图片可见**
